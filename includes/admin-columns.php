...
function content_audit_add_columns( $columns ) {
	...
	foreach ( $columns as $key => $value ) {
		...
		if ( 'Modified' === $key ) {
			$new_columns['last_review_date'] = esc_html__( 'Last Review Date', 'ab-content-audit' );
			$new_columns['next_review_date'] = esc_html__( 'Next Review Date', 'ab-content-audit' );
			$new_columns['stakeholder_name'] = esc_html__( 'Stakeholder', 'ab-content-audit' );
		}
	}
