 ...
 *
 * Available variables:
 * @var int    $content_id            The content ID being reviewed.
 * @var string $content_title         The title of the content.
 * @var string $live_site_url         The live site URL for the content.
 * @var string $stakeholder_name      The name of the stakeholder who submitted the review.
 * @var string $stakeholder_department The department of the stakeholder.
 * @var bool   $needs_changes         Whether changes are needed (true) or not (false).
 * @var string $support_ticket_url    The support ticket URL (optional, may be empty).
 * @var string $submissions_url       The admin URL to view all submissions.
